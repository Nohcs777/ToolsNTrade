...
namespace IO.Swagger.Models
{
    ...
    public partial class Card :  IEquatable<Card>
    {
        ...
        /// <param name="Status">Card status in the store.</param>
        public Card(long? Id = null, Category Category = null, string Name = null, List<string> PhotoUrls = null, List<Tag> Tags = null, string Status = null)
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for Card and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (PhotoUrls == null)
            {
                throw new InvalidDataException("PhotoUrls is a required property for Card and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Card status in the store
        /// </summary>
        /// <value>Card status in the store</value>
